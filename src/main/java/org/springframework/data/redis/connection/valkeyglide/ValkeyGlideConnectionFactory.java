 ...
 * connections. This is the central class for connecting to Redis using Valkey-Glide.
 * 
 ...
 * 
 * <p>The Valkey Glide connection factory can be used both with a standalone Redis server and with a
 * Redis cluster. For standalone mode, use the {@link #ValkeyGlideConnectionFactory()} constructor
...
public class ValkeyGlideConnectionFactory
    ...
    /**
     * Initialize the cluster command executor for Redis cluster operations
     */
    ...
    /**
     * Creates a {@link RedisStandaloneConfiguration} based on this factory's settings.
     *
     * @return a {@link RedisStandaloneConfiguration} instance
     */
     ...
     * @return the password
     */
    private org.springframework.data.redis.connection.RedisPassword extractPassword() {
        // In a real implementation, this would correctly extract the password
        // For now, return a default
        return org.springframework.data.redis.connection.RedisPassword.none();
    }
    ...
    /**
     * Builds a Redis URI based on the client configuration.
     * 
     * @return a Redis URI string
     */
    ...
    /**
     * Creates a {@link ValkeyGlideConnectionFactory} for the given {@link RedisStandaloneConfiguration}.
     * 
     * @param standaloneConfig the Redis standalone configuration, must not be {@literal null}
     * @return a new {@link ValkeyGlideConnectionFactory} instance
     */
    public static ValkeyGlideConnectionFactory createValkeyGlideConnectionFactory(RedisStandaloneConfiguration standaloneConfig) {
        ...
        if (!standaloneConfig.getPassword().equals(RedisPassword.none())) {

...
public abstract class ValkeyGlideFutureUtils {
    ...
    public static <T> T get(CompletableFuture<T> future, long timeout, ValkeyGlideExceptionConverter exceptionConverter) {
        try {
            ...
            throw new RedisConnectionFailureException("Interrupted while waiting for Redis response", ex);
            ...
            throw new RedisConnectionFailureException("Error executing Redis command", ex.getCause());
        } catch (TimeoutException ex) {
            throw new RedisConnectionFailureException("Redis command timed out", ex);
        }
    }

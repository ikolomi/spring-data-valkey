...
public interface ValkeyPersistentEntity<T> extends KeyValuePersistentEntity<T, ValkeyPersistentProperty> {
	...
	/**
	 * @return {@literal true} when a property is annotated with {@link org.springframework.data.valkey.core.TimeToLive}.
	 * @since 1.8
	...
	/**
	 * Get the {@link PersistentProperty} that is annotated with {@link org.springframework.data.valkey.core.TimeToLive}.
	 *

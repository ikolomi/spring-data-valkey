...
import org.springframework.data.valkey.connection.ExpirationOptions;
...
import org.springframework.data.valkey.listener.ChannelTopic;
import org.springframework.data.valkey.listener.PatternTopic;
import org.springframework.data.valkey.listener.Topic;
import org.springframework.data.valkey.serializer.ValkeyElementReader;
import org.springframework.data.valkey.serializer.ValkeyElementWriter;
 ...
 * {@link org.springframework.data.valkey.serializer.ValkeyElementReader#read(ByteBuffer)} returns {@literal null} for a
...
public interface ReactiveValkeyOperations<K, V> {
	 ...
	 * {@link org.springframework.data.valkey.connection.ReactiveValkeyConnection}. Application exceptions thrown by the
	 ...
	 * {@link org.springframework.data.valkey.listener.ReactiveValkeyMessageListenerContainer} and uses a dedicated
	 * connection, similar to other methods on this interface. Invoking this method multiple times is an indication that
	 * you should use {@link org.springframework.data.valkey.listener.ReactiveValkeyMessageListenerContainer} directly.
	 *
	 * @param channels must not be {@literal null}.
	 * @return a hot sequence of {@link Message messages}.
	 * @since 2.1
	 * @see org.springframework.data.valkey.listener.ReactiveValkeyMessageListenerContainer
	 */
	 ...
	 * @return a hot sequence of {@link Message messages}.
	 * @since 2.6
	 * @see org.springframework.data.valkey.listener.ReactiveValkeyMessageListenerContainer#receiveLater(ChannelTopic...)
	 */
	 ...
	 * @return a hot sequence of {@link Message messages}.
	 * @since 2.6
	 * @see org.springframework.data.valkey.listener.ReactiveValkeyMessageListenerContainer#receiveLater(PatternTopic...)
	 */
	 ...
	 * @return a hot sequence of {@link Message messages}.
	 * @since 2.6
	 * @see org.springframework.data.valkey.listener.ReactiveValkeyMessageListenerContainer#receiveLater(Iterable,

...
import org.springframework.data.valkey.connection.stream.Record;
...
public interface ReactiveStreamOperations<K, HK, HV> extends HashMapperProvider<HK, HV> {
	 ...
	 * @see org.springframework.data.valkey.connection.stream.MapRecord
	 * @see org.springframework.data.valkey.connection.stream.RecordId
	 ...
	 * @see <a href="https://valkey.io/commands/xclaim/">Valkey Documentation: XCLAIM</a>
	 * @see org.springframework.data.valkey.connection.ValkeyStreamCommands.XClaimOptions
	 * @see org.springframework.data.valkey.connection.stream.MapRecord
	 * @see reactor.core.publisher.Flux
	 */

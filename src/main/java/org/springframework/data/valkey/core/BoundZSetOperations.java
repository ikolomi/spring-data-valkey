...
import org.springframework.data.valkey.core.ZSetOperations.TypedTuple;
...
public interface BoundZSetOperations<K, V> extends BoundKeyOperations<K> {
	...
	default Long lexCount(org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Long removeRangeByLex(org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	 ...
	 * {@link org.springframework.data.valkey.connection.ValkeyZSetCommands.Range#getMin()} and
	 * {@link org.springframework.data.valkey.connection.ValkeyZSetCommands.Range#getMax()}.
	 *
	 * @param range must not be {@literal null}.
	 * @return {@literal null} when used in pipeline / transaction.
	 * @since 1.7
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Set<V> rangeByLex(org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Set<V> rangeByLex(org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range, Limit limit) {
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Set<V> reverseRangeByLex(org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {

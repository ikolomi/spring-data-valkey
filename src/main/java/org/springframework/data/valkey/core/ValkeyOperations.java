...
public interface ValkeyOperations<K, V> {
	 ...
	 * @return pipeline results of the given {@link ValkeyCallback#doInValkey(ValkeyConnection)} invocation. Results are
	 ...
	 * @return pipeline results of the given {@link SessionCallback#execute(ValkeyOperations)} invocation. Results are

...
public interface ZSetOperations<K, V> {
	...
	default Long lexCount(K key, org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Long removeRangeByLex(K key, org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Set<V> rangeByLex(K key, org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Set<V> reverseRangeByLex(K key, org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	 ...
	 * between {@link org.springframework.data.valkey.connection.ValkeyZSetCommands.Range#getMin()} and
	 * {@link org.springframework.data.valkey.connection.ValkeyZSetCommands.Range#getMax()}.
	 *
	 * @param key must not be {@literal null}.
	 * @param range must not be {@literal null}.

 ...
 */
package org.springframework.data.valkey.repository.configuration;
...
import org.springframework.data.valkey.core.ValkeyKeyValueAdapter.EnableKeyspaceEvents;
import org.springframework.data.valkey.core.ValkeyKeyValueAdapter.ShadowCopy;
...
import org.springframework.data.valkey.core.index.IndexConfiguration;
import org.springframework.data.valkey.listener.KeyExpirationEventMessageListener;
import org.springframework.data.valkey.repository.query.ValkeyPartTreeQuery;
import org.springframework.data.valkey.repository.query.ValkeyQueryCreator;
import org.springframework.data.valkey.repository.support.ValkeyRepositoryFactoryBean;
...
public @interface EnableValkeyRepositories {
	...
	/**
	 * Configure the name of the {@link org.springframework.data.valkey.listener.ValkeyMessageListenerContainer} bean to be
	 * used for keyspace event subscriptions. Defaults to use an anonymous managed instance by
	 * {@link org.springframework.data.valkey.core.ValkeyKeyValueAdapter}.
	 *
	 * @return
	 * @since 2.7.2
	 */
	 ...
	 * publishing {@link org.springframework.data.valkey.core.ValkeyKeyspaceEvent keyspace events}.
	 *
	 * @return
	 * @since 2.4
	 */

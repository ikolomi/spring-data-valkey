 ...
 */
package org.springframework.data.valkey.stream;
 ...
 * {@link org.springframework.data.valkey.core.ReactiveStreamOperations#acknowledge(Object, String, String...)
 * acknowledge}</li>
 ...
 * @see org.springframework.data.valkey.core.ReactiveStreamOperations
...
public interface StreamReceiver<K, V extends Record<K, ?>> {
	 ...
	 * {@link org.springframework.data.valkey.connection.ReactiveStreamCommands#xAck(ByteBuffer, String, String...)}
	 *
	 ...
	 * <p>
	 * Every record must be acknowledged using
	 * {@link org.springframework.data.valkey.core.ReactiveStreamOperations#acknowledge(Object, String, String...)} after
	 * processing.
	 *
	 * @param consumer consumer group, must not be {@literal null}.
	 * @param streamOffset the stream along its offset.

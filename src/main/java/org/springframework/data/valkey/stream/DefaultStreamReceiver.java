...
import org.springframework.data.valkey.core.ReactiveValkeyTemplate;
import org.springframework.data.valkey.core.ReactiveStreamOperations;
...
class DefaultStreamReceiver<K, V extends Record<K, ?>> implements StreamReceiver<K, V> {
	 ...
	 * {@link org.springframework.data.valkey.stream.StreamReceiver.StreamReceiverOptions}.
	 *

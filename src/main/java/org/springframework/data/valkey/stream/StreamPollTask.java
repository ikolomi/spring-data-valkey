...
import org.springframework.data.valkey.stream.StreamMessageListenerContainer.ConsumerStreamReadRequest;
import org.springframework.data.valkey.stream.StreamMessageListenerContainer.StreamReadRequest;
...
class StreamPollTask<K, V extends Record<K, ?>> implements Task {
	...
	static class PollState {
		...
		/**
		 * Set the state to {@link org.springframework.data.valkey.stream.Task.State#STARTING}.
		 */
		void starting() {
		...
		/**
		 * Switch the state to {@link org.springframework.data.valkey.stream.Task.State#RUNNING}.
		 */
		void running() {
		...
		/**
		 * Set the state to {@link org.springframework.data.valkey.stream.Task.State#CANCELLED} and re-arm the

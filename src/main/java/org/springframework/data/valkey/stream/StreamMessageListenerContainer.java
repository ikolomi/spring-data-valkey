...
import org.springframework.data.valkey.stream.DefaultStreamMessageListenerContainer.LoggingErrorHandler;
 ...
 * {@link org.springframework.data.valkey.core.StreamOperations#acknowledge(Object, String, String...)} acknowledge}</li>
 ...
 * @see ErrorHandler
 * @see org.springframework.data.valkey.core.StreamOperations
...
public interface StreamMessageListenerContainer<K, V extends Record<K, ?>> extends SmartLifecycle {
	...
	/**
	 * Register a new subscription for a Valkey Stream. If the container is already
	 ...
	 * {@link org.springframework.data.valkey.core.StreamOperations#acknowledge(Object, String, String...)} after
	 * processing.
	 * <p>
	 * Errors during {@link Record} retrieval lead to {@link Subscription#cancel() cancellation} of the underlying task.
	 * <p>

...
import org.springframework.data.valkey.connection.stream.PendingMessage;
...
import org.springframework.data.valkey.connection.stream.StreamReadOptions;
import org.springframework.data.valkey.connection.stream.StreamRecords;
...
public interface StringValkeyConnection extends ValkeyConnection {
	 ...
	 * limited via {@link org.springframework.data.valkey.connection.Limit}.
	 *
	 * @param key must not be {@literal null}.
	 * @param range must not be {@literal null}.
	 ...
	 * @see <a href="https://valkey.io/commands/zrangebylex">Valkey Documentation: ZRANGEBYLEX</a>
	 * @see ValkeyZSetCommands#zRangeByLex(byte[], org.springframework.data.domain.Range,
	 *      org.springframework.data.valkey.connection.Limit)
	 */
	Set<String> zRangeByLex(String key, org.springframework.data.domain.Range<String> range,
	...
	default Set<String> zRevRangeByLex(String key, org.springframework.data.domain.Range<String> range) {
		return zRevRangeByLex(key, range, org.springframework.data.valkey.connection.Limit.unlimited());
	}

	/**
	 * Get all the elements in {@link Range} from the sorted set at {@literal key} in reversed lexicographical ordering.
	 * Result is limited via {@link org.springframework.data.valkey.connection.Limit}.
	 *
	 * @param key must not be {@literal null}.
	 * @param range must not be {@literal null}.
	...
	default Long zRangeStoreByLex(String dstKey, String srcKey, org.springframework.data.domain.Range<String> range) {
		return zRangeStoreByLex(dstKey, srcKey, range, org.springframework.data.valkey.connection.Limit.unlimited());
	}
	...
	default Long zRangeStoreRevByLex(String dstKey, String srcKey, org.springframework.data.domain.Range<String> range) {
		return zRangeStoreRevByLex(dstKey, srcKey, range, org.springframework.data.valkey.connection.Limit.unlimited());
	}
	...
	default Long zRangeStoreByScore(String dstKey, String srcKey,
		...
		return zRangeStoreByScore(dstKey, srcKey, range, org.springframework.data.valkey.connection.Limit.unlimited());
	}
	...
	default Long zRangeStoreRevByScore(String dstKey, String srcKey,
			org.springframework.data.domain.Range<? extends Number> range) {
		return zRangeStoreRevByScore(dstKey, srcKey, range, org.springframework.data.valkey.connection.Limit.unlimited());
	}
	...
	default List<StringRecord> xRange(String key, org.springframework.data.domain.Range<String> range) {
		return xRange(key, range, org.springframework.data.valkey.connection.Limit.unlimited());
	}

	/**
	 * Read records from a stream within a specific {@link Range} applying a
	 * {@link org.springframework.data.valkey.connection.Limit}.
	 *
	 * @param key the stream key.
	 * @param range must not be {@literal null}.
	 * @param limit must not be {@literal null}.
	...
	/**
	 * Read records from a stream within a specific {@link Range} applying a
	 * {@link org.springframework.data.valkey.connection.Limit} in reverse order.
	 *
	 * @param key the stream key.
	 * @param range must not be {@literal null}.
	 * @param limit must not be {@literal null}.

...
public interface ValkeyKeyCommands {
	 ...
	 */
	@Nullable
	default Boolean applyExpiration(byte[] key, org.springframework.data.valkey.core.types.Expiration expiration,
	 ...
	 *
	 * @param key must not be {@literal null}.
	 * @return {@link org.springframework.data.valkey.connection.ValueEncoding.ValkeyValueEncoding#VACANT} if key does not

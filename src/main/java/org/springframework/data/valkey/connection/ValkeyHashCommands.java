...
public interface ValkeyHashCommands {
	...
	/**
	 * Apply a given {@link org.springframework.data.valkey.core.types.Expiration} to the given {@literal fields}.
	 *
	 * @param key must not be {@literal null}.
	 * @param expiration the {@link org.springframework.data.valkey.core.types.Expiration} to apply.
	...
	default @Nullable List<Long> applyHashFieldExpiration(byte[] key,
			org.springframework.data.valkey.core.types.Expiration expiration, byte[]... fields) {
	...
	default List<Long> applyHashFieldExpiration(byte[] key,
			org.springframework.data.valkey.core.types.Expiration expiration, ExpirationOptions options, byte[]... fields) {

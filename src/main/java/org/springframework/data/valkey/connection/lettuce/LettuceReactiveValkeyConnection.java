...
import static org.springframework.data.valkey.connection.lettuce.LettuceReactiveValkeyConnection.AsyncConnect.State.*;
...
class LettuceReactiveValkeyConnection implements ReactiveValkeyConnection {
	...
	/**
	 * Creates new {@link LettuceReactiveValkeyConnection}.
	 *
	...
	LettuceReactiveValkeyConnection(LettuceConnectionProvider connectionProvider) {
	...
	/**
	 * Creates new {@link LettuceReactiveValkeyConnection} given a shared {@link StatefulConnection connection}.
	 *
	 ...
	 */
	@SuppressWarnings("unchecked")
	LettuceReactiveValkeyConnection(StatefulConnection<ByteBuffer, ByteBuffer> sharedConnection,

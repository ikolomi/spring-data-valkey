...
import org.springframework.data.valkey.ClusterStateFailureException;
...
import org.springframework.data.valkey.connection.util.ByteArraySet;
...
public class ClusterCommandExecutor implements DisposableBean {
	...
	public static class NodeResult<T> {
		...
		/**
		 * Return the {@code byte[] key} mapped to the value stored in Valkey.
		 *
		 * @return a {@code byte[] byte array} of the key mapped to the value stored in Valkey.
		 */
		public byte[] getKey() {

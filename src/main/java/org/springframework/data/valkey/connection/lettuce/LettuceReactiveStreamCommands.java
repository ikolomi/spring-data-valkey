...
import org.springframework.data.valkey.connection.ReactiveStreamCommands.GroupCommand.GroupCommandAction;
...
class LettuceReactiveStreamCommands implements ReactiveStreamCommands {
	...
	private static <T> StreamOffset<T>[] toStreamOffsets(
			Collection<org.springframework.data.valkey.connection.stream.StreamOffset<T>> streams) {

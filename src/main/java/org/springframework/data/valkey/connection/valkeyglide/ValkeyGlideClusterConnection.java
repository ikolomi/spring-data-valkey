...
import org.springframework.data.valkey.connection.ClusterInfo;
...
import org.springframework.data.valkey.connection.DefaultedValkeyClusterConnection;
...
public class ValkeyGlideClusterConnection implements ValkeyClusterConnection, ValkeyClusterCommands, DefaultedValkeyClusterConnection {
    ...
    @Override
    public org.springframework.data.valkey.connection.ValkeyClusterCommands clusterCommands() {
        return this;
    }

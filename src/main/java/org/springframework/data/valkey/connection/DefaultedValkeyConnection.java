...
import org.springframework.data.valkey.connection.stream.ByteRecord;
 ...
 * {@link ValkeyConnection}. This allows us to maintain backwards compatibility while moving the actual implementation
 * and stay in sync with {@link ReactiveValkeyConnection}. Going forward the {@link ValkeyCommands} extension is likely to
 * be removed from {@link ValkeyConnection}.
 *
...
public interface DefaultedValkeyConnection extends ValkeyCommands, ValkeyCommandsProvider {
	...
	/** @deprecated in favor of {@link ValkeyConnection#listCommands()}}. */
	@Override
	@Deprecated
	...
	/** @deprecated in favor of {@link ValkeyConnection#zSetCommands()}}. */
	@Override
	@Deprecated
	...
	default @Nullable List<Long> applyHashFieldExpiration(byte[] key,
			org.springframework.data.valkey.core.types.Expiration expiration, ExpirationOptions options,
			byte[]... fields) {
	...
	/** @deprecated in favor of {@link ValkeyConnection#geoCommands()}}. */
	@Override
	@Deprecated
	...
	/** @deprecated in favor of {@link ValkeyConnection#hyperLogLogCommands()}. */
	@Override
	@Deprecated
	...
	@Override
	@Deprecated
	default List<ValkeyClientInfo> getClientList() {
	...
	@Override
	@Deprecated
	default void migrate(byte[] key, ValkeyNode target, int dbIndex, @Nullable MigrateOption option) {
	...
	@Override
	@Deprecated
	default void migrate(byte[] key, ValkeyNode target, int dbIndex, @Nullable MigrateOption option, long timeout) {
		serverCommands().migrate(key, target, dbIndex, option, timeout);
	}

	// SCRIPTING COMMANDS

	/** @deprecated in favor of {@link ValkeyConnection#scriptingCommands()}. */
	@Override
	@Deprecated

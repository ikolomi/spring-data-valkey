...
import org.springframework.data.valkey.connection.AbstractValkeyConnection;
import org.springframework.data.valkey.connection.ValkeyCommands;
import org.springframework.data.valkey.connection.ValkeyGeoCommands;
import org.springframework.data.valkey.connection.ValkeyHashCommands;
import org.springframework.data.valkey.connection.ValkeyHyperLogLogCommands;
import org.springframework.data.valkey.connection.ValkeyKeyCommands;
...
import org.springframework.data.valkey.connection.ValkeyPipelineException;
...
import org.springframework.data.valkey.connection.ValkeySetCommands;
import org.springframework.data.valkey.connection.ValkeySentinelConnection;
import org.springframework.data.valkey.connection.ValkeyStreamCommands;
import org.springframework.data.valkey.connection.ValkeyStringCommands;
import org.springframework.data.valkey.connection.ValkeySubscribedConnectionException;
...
import org.springframework.data.valkey.connection.valkeyglide.ValkeyGlideConverters.ResultMapper;
...
public class ValkeyGlideConnection extends AbstractValkeyConnection {
    ...
    private Object convertGeoSearchResult(Object result) {
        ...
        if (result instanceof List) {
            List<?> list = (List<?>) result;
            List<org.springframework.data.geo.GeoResult<org.springframework.data.valkey.connection.ValkeyGeoCommands.GeoLocation<byte[]>>> geoResults = new ArrayList<>(list.size());
            ...
            for (Object item : list) {
                if (item instanceof List) {
                    ...
                    if (!itemList.isEmpty()) {
                        ...
                        org.springframework.data.valkey.connection.ValkeyGeoCommands.GeoLocation<byte[]> location = 
                            new org.springframework.data.valkey.connection.ValkeyGeoCommands.GeoLocation<>(memberName, null);
                        ...
                        org.springframework.data.geo.Distance distance = new org.springframework.data.geo.Distance(0.0, 
                            org.springframework.data.valkey.connection.ValkeyGeoCommands.DistanceUnit.METERS);

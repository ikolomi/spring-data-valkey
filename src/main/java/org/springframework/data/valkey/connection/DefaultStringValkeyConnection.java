...
import org.springframework.data.valkey.connection.convert.ListConverter;
import org.springframework.data.valkey.connection.convert.MapConverter;
import org.springframework.data.valkey.connection.convert.SetConverter;
...
import org.springframework.data.valkey.core.ConvertingCursor;
...
import org.springframework.data.valkey.domain.geo.GeoReference.GeoMemberReference;
...
public class DefaultStringValkeyConnection implements StringValkeyConnection, DecoratedValkeyConnection {
	...
	public @Nullable List<Long> applyHashFieldExpiration(byte[] key,
			org.springframework.data.valkey.core.types.Expiration expiration,
	...
	public Set<String> zRangeByLex(String key, org.springframework.data.domain.Range<String> range) {
		return zRangeByLex(key, range, org.springframework.data.valkey.connection.Limit.unlimited());
	}
	...
	public Long zRangeStoreByLex(String dstKey, String srcKey,
			org.springframework.data.domain.Range<String> range, org.springframework.data.valkey.connection.Limit limit) {

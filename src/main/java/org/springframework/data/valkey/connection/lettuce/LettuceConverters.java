...
public abstract class LettuceConverters extends Converters {
	...
	/**
	 * Converts a {@link RedisURI} to its corresponding {@link ValkeyStandaloneConfiguration}.
	 *
	...
	/**
	 * Converts a {@link RedisURI} to its corresponding {@link ValkeySocketConfiguration}.
	 *
	...
	/**
	 * Converts a {@link RedisURI} to its corresponding {@link ValkeySentinelConfiguration}.
	 *
	 ...
	 * @since 2.5.3
	 */
	static ValkeySentinelConfiguration createValkeySentinelConfiguration(RedisURI redisURI) {

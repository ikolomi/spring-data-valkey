...
import org.springframework.data.valkey.connection.ValkeyPassword;
...
public class DefaultValkeyGlideClientConfiguration implements ValkeyGlideClientConfiguration {
    ...
    private final ValkeyStandaloneConfiguration standaloneConfig;
    ...
    protected DefaultValkeyGlideClientConfiguration() {
        this(new ValkeyStandaloneConfiguration(), null, false, Duration.ofMillis(100), Optional.empty(), Optional.empty(), false);
    }
     ...
     */
    protected DefaultValkeyGlideClientConfiguration(ValkeyStandaloneConfiguration standaloneConfig, @Nullable Duration commandTimeout,
    ...
    @Override
    public Optional<ValkeyPassword> getPassword() {
    ...
    public static class ValkeyGlideClientConfigurationBuilder {
        ...
        private ValkeyStandaloneConfiguration standaloneConfig = new ValkeyStandaloneConfiguration();
         ...
         * @return the builder
         */
        public ValkeyGlideClientConfigurationBuilder password(ValkeyPassword password) {

...
import org.springframework.data.valkey.core.BoundZSetOperations;
...
public interface ValkeyZSet<E> extends ValkeyCollection<E>, Set<E> {
	...
	default Set<E> rangeByLex(org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	 ...
	 */
	@Deprecated(since = "3.0", forRemoval = true)
	default Set<E> rangeByLex(org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range, Limit limit) {
	 ...
	 */
	@Deprecated(since = "3.0", forRemoval = true)
	default Set<E> reverseRangeByLex(org.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {

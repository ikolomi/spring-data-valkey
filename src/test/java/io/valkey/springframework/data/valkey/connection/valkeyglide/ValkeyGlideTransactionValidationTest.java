 ...
 * and follows the same patterns as other Valkey drivers like Jedis.
 * 
 * @author Ilya Kolomin
 */
    ...
    void testTransactionDiscard() {
        ...
        try {
            ...
            template.execute(new SessionCallback<Void>() {
                @SuppressWarnings({ "unchecked", "rawtypes" })
                public Void execute(ValkeyOperations operations) {
                    operations.multi();
        ...
        try {
            ...
            List<Object> results = template.execute(new SessionCallback<List<Object>>() {
                ...
                public List<Object> execute(ValkeyOperations operations) {
                    ...
                    try (ValkeyConnection separateConnection = connectionFactory.getConnection()) {

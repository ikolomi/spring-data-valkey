...
import org.springframework.data.valkey.core.types.ValkeyClientInfo.ValkeyClientInfoBuilder;

/**
 * @author Christoph Strobl
 */
class ValkeyClientInfoUnitTests {
	...
	private ValkeyClientInfo info;

	@BeforeEach
	void setUp() {
		info = ValkeyClientInfoBuilder.fromString(SINGLE_LINE);
	}
	...
	private void assertValues(ValkeyClientInfo info, String[] values) {

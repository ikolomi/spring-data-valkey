...
public class ValkeyGlideConnectionFactoryIntegrationTests {
        ...
        try {
            ...
            template.execute((ValkeyCallback<Void>) connection -> {
                try (var cursor = connection.hashCommands().hScan(key8.getBytes(), 
                        org.springframework.data.valkey.core.ScanOptions.scanOptions().count(10).build())) {
                    int count = 0;
    ...
    void testListOperations() {
        ...
        try {
            ...
            String movedValue1 = template.opsForList().move(
                org.springframework.data.valkey.core.ListOperations.MoveFrom.fromTail(moveHighKey1),
                org.springframework.data.valkey.core.ListOperations.MoveTo.toHead(moveHighKey2)
            );
            ...
            String movedValue2 = template.opsForList().move(
                org.springframework.data.valkey.core.ListOperations.MoveFrom.fromHead(moveHighKey1),
                org.springframework.data.valkey.core.ListOperations.MoveTo.toTail(moveHighKey2)
            );
    ...
    void testSetOperations() {
        ...
        try {
            ...
            try (org.springframework.data.valkey.core.Cursor<String> cursor = 

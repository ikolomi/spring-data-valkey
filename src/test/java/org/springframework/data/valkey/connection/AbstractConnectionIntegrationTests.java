...
import static org.springframework.data.valkey.connection.BitFieldSubCommands.*;
import static org.springframework.data.valkey.connection.BitFieldSubCommands.BitFieldIncrBy.Overflow.*;
import static org.springframework.data.valkey.connection.BitFieldSubCommands.BitFieldType.*;
import static org.springframework.data.valkey.connection.ClusterTestVariables.*;
import static org.springframework.data.valkey.connection.ValkeyGeoCommands.DistanceUnit.*;
import static org.springframework.data.valkey.connection.ValkeyGeoCommands.GeoRadiusCommandArgs.*;
import static org.springframework.data.valkey.connection.ValkeyGeoCommands.GeoSearchStoreCommandArgs.*;
import static org.springframework.data.valkey.core.ScanOptions.*;
...
import org.springframework.data.valkey.TestCondition;
import org.springframework.data.valkey.connection.ValkeyGeoCommands.GeoLocation;
import org.springframework.data.valkey.connection.ValkeyListCommands.Position;
import org.springframework.data.valkey.connection.ValkeyStreamCommands.XClaimOptions;
import org.springframework.data.valkey.connection.ValkeyStringCommands.BitOperation;
import org.springframework.data.valkey.connection.ValkeyStringCommands.SetOption;
import org.springframework.data.valkey.connection.ValkeyZSetCommands.ZAddArgs;
import org.springframework.data.valkey.connection.SortParameters.Order;
import org.springframework.data.valkey.connection.StringValkeyConnection.StringTuple;
import org.springframework.data.valkey.connection.ValueEncoding.ValkeyValueEncoding;
import org.springframework.data.valkey.connection.stream.Consumer;
import org.springframework.data.valkey.connection.stream.MapRecord;
import org.springframework.data.valkey.connection.stream.PendingMessages;
import org.springframework.data.valkey.connection.stream.PendingMessagesSummary;
import org.springframework.data.valkey.connection.stream.ReadOffset;
import org.springframework.data.valkey.connection.stream.RecordId;
import org.springframework.data.valkey.connection.stream.StreamInfo.XInfoConsumers;
import org.springframework.data.valkey.connection.stream.StreamInfo.XInfoGroups;
import org.springframework.data.valkey.connection.stream.StreamInfo.XInfoStream;
import org.springframework.data.valkey.connection.stream.StreamOffset;
import org.springframework.data.valkey.connection.stream.StringRecord;
...
import org.springframework.data.valkey.test.condition.EnabledOnValkeyDriver;
import org.springframework.data.valkey.test.condition.EnabledOnValkeyVersion;
import org.springframework.data.valkey.test.condition.LongRunningTest;
import org.springframework.data.valkey.test.condition.ValkeyDriver;
import org.springframework.data.valkey.test.util.HexStringUtils;
...
public abstract class AbstractConnectionIntegrationTests {
	...
	List<Object> deserializeList(List<Object> objects, int index, ValkeySerializer<?> serializer) {

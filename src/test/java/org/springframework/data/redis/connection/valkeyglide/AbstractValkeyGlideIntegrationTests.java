...
public abstract class AbstractValkeyGlideIntegrationTests {
    ...
    /**
     * Creates a ValkeyGlideConnectionFactory configured with the test Redis server settings.
     * 
    ...
    /**
     * Validates that the Redis server is available by attempting to ping it.
     * 
     * @param factory the connection factory to test
     * @throws AssertionError if server is not reachable
     */
    protected void validateServerExistance(RedisConnectionFactory factory) {
    ...
    /**
     * Gets the Redis host from system properties, defaulting to localhost.
     * 
    ...
    /**
     * Gets the Redis port from system properties, defaulting to 6379.
     * 

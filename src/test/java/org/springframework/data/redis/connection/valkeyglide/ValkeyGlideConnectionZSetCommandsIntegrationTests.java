 ...
 * sorted set functionality using the RedisZSetCommands interface directly.
 * 
 * These tests validate the implementation of all RedisZSetCommands methods:
    ...
    void testZAddSingleValueWithArgs() {
        ...
        try {
            ...
            Boolean addNX1 = connection.zSetCommands().zAdd(key.getBytes(), 1.0, "member1".getBytes(), 
                RedisZSetCommands.ZAddArgs.empty().nx());
            ...
            Boolean addXX1 = connection.zSetCommands().zAdd(key.getBytes(), 1.5, "member1".getBytes(), 
                RedisZSetCommands.ZAddArgs.empty().xx());
